...
GetCommunityEventsModel getCommunityEventsModelFromJson(String str) =>
    GetCommunityEventsModel.fromJson(json.decode(str));

String getCommunityEventsModelToJson(GetCommunityEventsModel data) =>
