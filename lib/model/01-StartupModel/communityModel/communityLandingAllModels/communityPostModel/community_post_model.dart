...
CommunityPostModel communityPostModelFromJson(String str) {
  try {
    ...
    return CommunityPostModel(status: false, message: "Error decoding JSON", data: CommunityPost(postData: [], communityData: Community(id: "", name: "", whatsappGroupLink: "")));
  }
}
  ...
  factory CommunityPostModel.fromJson(Map<String, dynamic> json) {
    try {
      return CommunityPostModel(
        ...
        message: json["message"] ?? '',
        data: json["data"] != null ? CommunityPost.fromJson(json["data"]) : null,
      );
    } catch (e) {
      print("Error parsing CommunityPostModel: $e");
      return CommunityPostModel(status: false, message: "Error parsing JSON", data: null);
    }
  }
...
class HomePost {
    ...
    try {
      return HomePost(
        ...
        pollOptions: json["pollOptions"] != null
            ? List<PollOptionData>.from(json["pollOptions"].map((x) => PollOptionData.fromJson(x)))
            : [],
        myVotes: json["myVotes"] != null ? List<String>.from(json["myVotes"]) : [],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "pollOptions": pollOptions != null
            ...
            : [],
        "myVotes": myVotes != null ? List<dynamic>.from(myVotes!.map((x) => x)) : [],
...
class PollOptionData {
  ...
  factory PollOptionData.fromJson(Map<String, dynamic> json) {
    try {
      ...
      return PollOptionData(id: "", option: "", numberOfVotes: 0, hasVoted: false);
    }
  }
