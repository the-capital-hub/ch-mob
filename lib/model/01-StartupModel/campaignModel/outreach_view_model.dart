...
OutreachViewModel outreachViewModelFromJson(String str) => OutreachViewModel.fromJson(json.decode(str));

String outreachViewModelToJson(OutreachViewModel data) => json.encode(data.toJson());
...
class OutreachViewModel {
    ...
    factory OutreachViewModel.fromJson(Map<String, dynamic> json) => OutreachViewModel(
        status: json["status"],
...
class OutreachView {
    ...
    factory OutreachView.fromJson(Map<String, dynamic> json) => OutreachView(
        ...
        recipients: json["recipients"] == null ? null : Recipients.fromJson(json["recipients"]),
        emailContent: json["emailContent"] == null ? null : EmailContent.fromJson(json["emailContent"]),
    );
...
class Overview {
    ...
    factory Overview.fromJson(Map<String, dynamic> json) => Overview(
        ...
        investorLists: json["investorLists"] == null ? [] : List<String>.from(json["investorLists"]!.map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "replied": replied,
        "bounced": bounced,
        "investorLists": investorLists == null ? [] : List<dynamic>.from(investorLists!.map((x) => x)),
    };
}
