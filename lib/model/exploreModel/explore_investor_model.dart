...
ExploreInvestorModel exploreInvestorModelFromJson(String str) =>
    ExploreInvestorModel.fromJson(json.decode(str));

String exploreInvestorModelToJson(ExploreInvestorModel data) =>
...
class ExploreInvestorModel {
  ...
  factory ExploreInvestorModel.fromJson(Map<String, dynamic> json) =>
      ExploreInvestorModel(
        status: json["status"],
        message: json["message"],
        data: List<InvestorExplore>.from(
            json["data"].map((x) => InvestorExplore.fromJson(x))),
      );
...
class InvestorExplore {
  ...
  factory InvestorExplore.fromJson(Map<String, dynamic> json) =>
      InvestorExplore(
        name: json["name"],
        ...
        startupsInvested: List<StartupsInvested>.from(
            json["startupsInvested"].map((x) => StartupsInvested.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "linkedin": linkedin,
        "startupsInvested":
            List<dynamic>.from(startupsInvested!.map((x) => x.toJson())),
