  ...
  void initState() {
    ...
    _tabController.addListener(() {
      if (_tabController.indexIsChanging) {
        // Call different getALLScheduledMeetings depending on the selected tab
    ...
    // Initially fetch the "upcoming" meetings
           ...
           Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
                ...
                meetingController.isLoading.value
                      ...
                      ? Center(child: TextWidget(text: "No Meetings Available", textSize: 16))
                      :
              ...
              child: TabBarView(controller: _tabController, children: [
                ListView.separated(
                    itemCount: meetingController.meetingsList.length,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      sizedTextfield,
                       TextWidget(
                        text: meetingController.meetingsList[index].title,
                        textSize: 25,
