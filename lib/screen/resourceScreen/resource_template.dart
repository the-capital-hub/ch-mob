            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    children: [
                      const TextWidget(text: 'Ready - to - Use Templates',
                        textSize: 30,
                      ...
                      const TextWidget(text: 'Access to events, unlock investors database and more at 1,999/-',
                        textSize: 18,
                        align: TextAlign.center,
                        maxLine: 2,
                      ),
                      ...
                      const SizedBox(height: 10,),
                      const TextWidget(text: 'Join Hustlers Club ?',
                        textSize: 25,
                        align: TextAlign.center,
                        fontWeight: FontWeight.bold,
                        maxLine: 1,
                      ...
                      const SizedBox(height: 5,),
                      const TextWidget(text: 'Get ready to use templates',
                        textSize: 18,
                        align: TextAlign.center,
                        maxLine: 2,
                      ),
                      const SizedBox(height: 20,),
                      Image.asset(PngAssetPath.foxCurveImg,
                      ),
                  ...
                  child: LayoutBuilder(
                    builder: (BuildContext context, BoxConstraints constraints) {
                      return Wrap(
                        spacing: 15,
                        runSpacing: 15,
                        children: List<Widget>.generate(resourceController.menuTemplatesName.length,(index){
                          return InkWell(
                ...
                Center(
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: const TextWidget(text: 'View All',
                        textSize: 15,
                        maxLine:1,
                        fontWeight: FontWeight.bold,
                      ),
