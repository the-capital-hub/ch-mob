...
import '../../controller/liveDealsController/live_deals_controller.dart';
...
import '../startupSPV/startupSPV_landing_screen.dart';

class LiveDealDetailScreen extends StatefulWidget {
  final int index;
  const LiveDealDetailScreen({super.key, required this.index});

  @override
  State<LiveDealDetailScreen> createState() => _LiveDealDetailScreenState();
}

class _LiveDealDetailScreenState extends State<LiveDealDetailScreen>
    with TickerProviderStateMixin {
  LiveDealsController liveDealsController = Get.find();
    ...
    return Container(
      ...
      child: Scaffold(
        floatingActionButton: FloatingActionButton(onPressed: () {
          Get.to(() => const StartupspvLandingScreen());
        }),
        backgroundColor: AppColors.black,
        appBar: HelperAppBar.appbarHelper(title: "Live Deals"),
        body: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (liveDealsController
                        .liveDealsList[index].socialLinks!.isNotEmpty)
                      SizedBox(
                        height: 42,
                        child: ListView.separated(
                          itemCount: liveDealsController
                              .liveDealsList[index].socialLinks!.length,
                          shrinkWrap: true,
                              ...
                              child: Card(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Image.network(
                                        liveDealsController.liveDealsList[index]
                                            .socialLinks![ind].logo!,
                                        height: 25,
                                      ),
                                      const SizedBox(width: 8),
                                      TextWidget(
                    ...
                    if (liveDealsController
                        .liveDealsList[index].interestedInvestors!.isNotEmpty)
                      const Padding(
                        padding:
                    ...
                    if (liveDealsController
                      ...
                      SizedBox(
                        ...
                        child: ListView.separated(
                          itemCount: liveDealsController
                              .liveDealsList[index].interestedInvestors!.length,
                          shrinkWrap: true,
                          separatorBuilder: (context, ind) {
                            return const SizedBox(width: 3);
                          },
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          sizedTextfield,
                          if (liveDealsController
                                  .liveDealsList[index].pitchRecordings !=
                              null)
                            Card(
                                color: AppColors.white12,
                                surfaceTintColor: AppColors.white12,
                          ...
                          if (liveDealsController
                                  .liveDealsList[index].upcomingPitchDay !=
                              null) ...[
                            sizedTextfield,
                            Card(
                                color: AppColors.white12,
                          ...
                          Expanded(
                              child: AppButton.primaryButton(
                                    ...
                                    if (liveDealsController
                                      ...
                                      liveDealsController
                                        ...
                                        id: liveDealsController
                                            .liveDealsList[index].liveDealId!,
                                      )
                                          .then((val) {
                                        if (val) {
                                          if (liveDealsController
                                  ...
                                  title: liveDealsController
                                      .liveDealsList[index].myInterest!)),
                          const SizedBox(width: 12),
                          Expanded(
                              child: AppButton.primaryButton(
                                  borderRadius: 12,
                      ...
                      child: AppButton.outlineButton(
                          onButtonPressed: () {
                            Get.to(() => PublicProfileScreen(
                                id: liveDealsController
                                    .liveDealsList[index].founder!.id!));
                          },
