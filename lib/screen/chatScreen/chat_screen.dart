...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      chatController.getChats(widget.member.chatId).then((v) {
          ...
          appBar: AppBar(
              ...
              leading: Row(
                children: [
                  ...
                  CircleAvatar(
                    radius: 21,
                    backgroundImage: NetworkImage(widget.member.senderImage),
                  ),
                ],
              ),
              titleSpacing: 0,
              ...
              title: Column(
                ...
                children: [
                  TextWidget(text: widget.member.senderName, textSize: 16),
                  TextWidget(
                      text: widget.member.senderDesignation,
              ...
              actions: [
                PopupMenuButton<String>(
                    ...
                    onSelected: (value) {
                      if (value == 'clear_chat') {
                        chatController
                            .clearChat(context, widget.member.chatId)
                            .then((v) {
                          setState(() {});
                        });
                      } else if (value == 'block_user') {
                        chatController.blockUnblock(
                            context, widget.member.senderId);
                      }
                    },
                    itemBuilder: (context) => [
                          const PopupMenuItem(
