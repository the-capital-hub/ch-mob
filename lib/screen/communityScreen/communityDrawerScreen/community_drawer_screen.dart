...
//   ];
//   // List page = [
//   //   CommunityLandingScreen(index:0),
//   //   CommunityLandingScreen(index:1),
//   //   CommunityLandingScreen(index:2),
//   //   CommunityLandingScreen(index:3),
//   //   CommunityLandingScreen(index:4),
//   //   const ProfileScreen(),
//   // ];
...
//                           return InkWell(
//                             onTap: () {
//                              // Use Get.to() to navigate to the correct screen
//                             if (index == 5) {
//                               // Navigate to Profile screen (since it's a separate screen)
//                               Get.to(const ProfileScreen());
                             
//                             } else {
//                               // Navigate to CommunityLandingScreen with the correct index
//                               Get.to(() =>  CommunityLandingScreen(index: index,));
//                             }
//                             },
//                             child: Container(
