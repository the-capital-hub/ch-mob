                                  ...
                                  ? InkWell(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          slot = isSlotSelected
                                              ? "${communityMeetings.communityMeetingsList[widget.index].availability![availabilityIndex].slots![index].startTime} - ${communityMeetings.communityMeetingsList[widget.index].availability![availabilityIndex].slots![index].endTime}"
                                              : "";
