                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              //     ),
                              //      TextWidget(
                              //         text: "${communityWebinars.communityEventsData[widget.index].duration} - ${communityWebinars.communityEventsData[widget.index].duration}", textSize: 16)
                              //   ],
                              // ),
                              // sizedTextfield,
                              Row(
                        ...
                        child: Column(
                          children: [
                            ...
                            MyCustomTextField.textField(
                                ...
                                controller: communityWebinars.mobileController,
                            ...
                            AppButton.primaryButton(
                                onButtonPressed: () {
                                  ...
                                  communityWebinars.registerCommunityWebinar(
                                      communityWebinars
                                          .communityWebinarsList[widget.index]
                                          .id
                                          .toString());
