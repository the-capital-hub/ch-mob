...
class CommunityProductsAndServicesScreen extends StatefulWidget {
  ...
  @override
  State<CommunityProductsAndServicesScreen> createState() => _CommunityProductsAndServicesScreenState();
}

class _CommunityProductsAndServicesScreenState extends State<CommunityProductsAndServicesScreen> with SingleTickerProviderStateMixin {
            ...
            child: Container(
              decoration: BoxDecoration(
                color: _tabController.index == 0
                    ...
                    : AppColors.white12, // Grey background for unselected tabs
                borderRadius: BorderRadius.circular(5),
              ),
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 12,vertical: 11.0),
                child: Text("Products"),
              ),
            ),
          ),
