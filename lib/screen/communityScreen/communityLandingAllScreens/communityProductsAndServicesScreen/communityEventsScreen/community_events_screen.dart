...
import 'package:capitalhub_crm/model/communityModel/communityLandingAllModels/communityEventsModel/community_event_model.dart';
                    ...
                    children: [
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemCount: communityEvents.hashCode.bitLength,
                          shrinkWrap: true,
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                TextWidget(
                                                    text:
                                                        "${communityEvents.dateController} Minutes",
                                                    textSize: 14),
                                                TextWidget(
                                                    text:
                                                        "${communityEvents.dateController} Bookings",
                                                    textSize: 14),
                                              ],
                                            ),
                                            const Spacer(),
