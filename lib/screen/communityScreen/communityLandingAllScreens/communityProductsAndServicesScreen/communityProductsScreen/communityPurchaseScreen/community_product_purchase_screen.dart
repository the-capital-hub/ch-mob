...
class ProductPurchaseScreen extends StatefulWidget {
  int index;
  ProductPurchaseScreen({required this.index, super.key});
...
class _ProductPurchaseScreenState extends State<ProductPurchaseScreen> {
                        ...
                        children: [
                          ...
                          TextWidget(
                              text: communityProducts
                                  .communityMembersList[widget.index].firstName,
                              textSize: 13),
                          const SizedBox(height: 8),
                          Divider(
                            color: AppColors.white38,
                          ...
                          HtmlWidget(
                            communityProducts
                                .communityMembersList[widget.index].id,
                            textStyle:
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  TextWidget(
                                      text:
                                          "${communityProducts.communityMembersList[widget.index].company} Files",
                                      textSize: 13),
                                ],
                              ),
                              Column(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  TextWidget(
                                      text:
                                          "\u{20B9}${communityProducts.communityMembersList[widget.index].designation}/-",
                                      textSize: 13),
                                ],
                              ),
                            ],
  ...
  _joinTap() {
    ...
    communityProducts.buyProduct(
        communityProducts.communityMembersList[widget.index].id, "");
  }
}
