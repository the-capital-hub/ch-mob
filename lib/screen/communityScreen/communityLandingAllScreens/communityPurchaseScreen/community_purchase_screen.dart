      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children:[
                Image.asset(PngAssetPath.puechaseProductImg,height: 250,),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    TextWidget(text: "Name:", textSize: 16, fontWeight: FontWeight.w500,color: AppColors.primary,),
                    SizedBox(height: 8),
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            TextWidget(text: "Resources", textSize: 16, fontWeight: FontWeight.w500,color: AppColors.primary,),
SizedBox(height: 8),
 TextWidget(text: "${communityProducts.communityProductsList[widget.index].urls.length} Files", textSize: 13),
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
  children: [
    TextWidget(text: "Access", textSize: 16, fontWeight: FontWeight.w500,color: AppColors.primary,),
 SizedBox(height: 8),
