...
//           communityEvents.communityEventList[widget.index!].title!;
//       communityEvents.durationMinutesController.text =
//           "${communityEvents.communityEventList[widget.index!].duration}";
//       communityEvents.priceController.text =
//           "${communityEvents.communityEventList[widget.index!].price}";
//       communityEvents.priceDiscountController.text =
//           "${communityEvents.communityEventList[widget.index!].discount}";
//     }
...
//       }
//       String inputDate = communityWebinars.communityWebinarsList[widget.index!]
...
//           communityWebinars.communityWebinarsList[widget.index!].startTime!;
//       communityWebinars.endTimeController.text =
//           communityWebinars.communityWebinarsList[widget.index!].endTime!;
...
//                   !emailRegex
//                       .hasMatch(communityMeetings.memberEmailController.text)) {
//                 HelperSnackBar.snackBar("Error", "Enter a valid email address");
...
//           communityEvents.communityEventList[widget.index!].description!);
//     }
...
//                     communityEvents.getCommunityEvent();
//                   } else {
//                     Helper.loader(context);
...
//         widget.isEdit && widget.isWebinar
//             ? base64 != ""
//                 ? CircleAvatar(
//                     radius: 60,
//                     backgroundImage: MemoryImage(base64Decode(base64)),
...
//                 : CircleAvatar(
//                     radius: 60,
//                     backgroundImage: NetworkImage(communityWebinars
