...
class CommunityPriorityDMsScreen extends StatefulWidget {
  ...
  @override
  State<CommunityPriorityDMsScreen> createState() => _CommunityPriorityDMScreenState();
}

class _CommunityPriorityDMScreenState extends State<CommunityPriorityDMsScreen> {
   List<String> data = [
    "Sector Agnostic",
    "B2B",
    "B2C",
