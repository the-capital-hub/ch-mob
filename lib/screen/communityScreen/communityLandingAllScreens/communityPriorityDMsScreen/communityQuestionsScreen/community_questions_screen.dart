                        ...
                        child: Column(
                          ...
                          children: [
                            const Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    TextWidget(
                                        text: "Asked 12 days ago",
                                        textSize: 13),
                                    SizedBox(
                                      height: 8,
                                    ),
                                    TextWidget(
                                      text: "Time to answer:Time expired",
                                      textSize: 13,
                            ...
                            AppButton.primaryButton(
                                onButtonPressed: () {}, title: "Submit Answer")
                          ],
                        ),
                      ),
                    );
                          ...
                          children: [
                            const Row(
                              children: [
                                ...
                                Spacer(),
                                TextWidget(
                                    text: "Asked 16 days ago", textSize: 13),
                              ],
                            ),
                            sizedTextfield,
                            const TextWidget(
                            ...
                            sizedTextfield,
                            const TextWidget(text: "Answer:", textSize: 16),
                            const TextWidget(text: "Solution", textSize: 16),
                          ],
                        ),
                      ),
                    );
