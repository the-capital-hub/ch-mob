...
class _PollWidgetState extends State<CommunityPollWidget> {
  CommunityHomeController communityHomeController = Get.find();
  ...
  void toggleVote(String pollId, int index) {
    ...
    communityHomeController.voteCommunityPost(context, postID: widget.postId, optionID: pollId);
  }
