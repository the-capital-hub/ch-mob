...
class CommunityRegisterNowScreen extends StatefulWidget {
  ...
  @override
  State<CommunityRegisterNowScreen> createState() => _CommunityRegisterNowScreenState();
}

class _CommunityRegisterNowScreenState extends State<CommunityRegisterNowScreen> {
                ...
                children:[
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          TextWidget(text: "Nitin Kumar", textSize: 16,fontWeight: FontWeight.bold,),
                          TextWidget(text: " invites you to join!", textSize: 16,color: AppColors.primary,),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextWidget(text: "Title", textSize: 20, fontWeight: FontWeight.w500,),
                ...
                side: BorderSide(
                  ...
                  width: 1, // Border width
                       ...
                       child: Padding(
                         ...
                         child: Column(
                           children: [
                             TextWidget(text: "Register for Webinar", textSize: 20, fontWeight: FontWeight.w500,),
                             SizedBox(height: 8,),
                             TextWidget(text: "Please fill in your details to proceed", textSize: 16),
                             sizedTextfield,
                             MyCustomTextField.textField(hintText: "Enter Name", controller: urlController, lableText: "Name",borderClr: AppColors.white12),
                                     SizedBox(height: 12),
                                     MyCustomTextField.textField(hintText: "Enter Email", controller: urlController, lableText: "Email",borderClr: AppColors.white12),
                                     SizedBox(height: 12),
                                     MyCustomTextField.textField(hintText: "Enter Mobile Number", controller: urlController, lableText: "Mobile Number",borderClr: AppColors.white12),
                                     SizedBox(height: 12),
                                     AppButton.primaryButton(onButtonPressed: (){}, title: "Register Now"),
                                     sizedTextfield,
                           ],
                         ),
                       ),
